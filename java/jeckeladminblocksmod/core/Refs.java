...
import jeckeladminblocksmod.proxy.CommonProxy;
...
public class Refs
{
	public static final String ModId = "jeckeladminblocksmod";
	public static final String ModName = "JeckelAdminBlocksMod";
